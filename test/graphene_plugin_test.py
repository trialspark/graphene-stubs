"""Mypy style test cases for Graphene stubs and plugin."""
...
test_data_prefix = os.path.join(prefix, 'test', 'test-data', 'unit')


class GraphenePluginTest(DataSuite):
    files = [
        'graphene_plugin.test',
    ]
    ...
    def run_case(self, testcase: DataDrivenTestCase) -> None:
        ...
        mypy_cmdline = [
            ...
            '--config-file={}/mypy_plugin.ini'.format(inipath),
        ]
